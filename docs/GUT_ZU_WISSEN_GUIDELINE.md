# Guideline: Bereich „Gut zu wissen“

## Ziel des Bereichs

„Gut zu wissen“ ist ein optionaler Vertiefungsbereich in der App.  
...
- Die Wochen bleiben didaktischer Kern.
- „Gut zu wissen“ ist freiwillig und thematisch organisiert.
- Inhalte sollen anschlussfähig sein an MBSR (Aufmerksamkeit, Selbstregulation, Selbstfürsorge, Dranbleiben).
- Pro Thema kann es kurze Querverweise aus Wochen geben (z. B. W1, W8), aber keine Zusatzlast in den Wochen selbst.
...
- zu weit vom Kursfokus wegführt.
...
- Evidenz vorsichtig formulieren:
  ...
  - vermeiden: „wirkt sicher“, „führt direkt zu“
...
- „Meditation ersetzt Schlaf/Therapie.“

---

## Evidenz- und Quellenpraxis

- Aussagen nur so stark formulieren, wie es die Daten tragen.
- Bei uneinheitlicher Studienlage transparent bleiben.
- Keine Scheingenauigkeit (keine unnötigen Zahlen ohne Kontext).
- Wenn Quellen genannt werden, dann knapp und sinnvoll.
- Ziel ist Orientierung für Teilnehmende, nicht akademische Vollständigkeit.
...
- Bei neuen Karten prüfen:
  1. Überschneidung mit Wochenkarten?
  2. MBSR-Kompatibilität?
  3. Sprachton konsistent?
  4. Evidenz sauber eingeordnet?

---

## Redaktions-Check vor Veröffentlichung

1. **Relevanz:** Passt es zum Kursziel?  
2. **Klarheit:** Ist der Text in Alltagssprache verständlich?  
3. **Haltung:** Kein Optimierungsdruck, kein Moralisieren.  
4. **Evidenz:** Aussagen korrekt eingegrenzt.  
5. **Praxisbezug:** Ein konkreter, machbarer Impuls enthalten.  
6. **Kürze:** Kein unnötiger Ballast.
