...
Stand: 26.02.2026 (historischer Snapshot)

Scope dieses Schritts: nur Inventarisierung der damaligen UI, keine strukturellen Refactors. **Hinweis:** Die genannten Duplikate (z. B. Header, Audio-/PDF-Karten) sind inzwischen größtenteils durch Shared Widgets abgelöst; dieses Dokument bleibt als Nachvollziehbarkeit. Pfade sind relativ zum Projektordner `mbsr_app/`.

## 1) Relevante Seiten und Zweck

### 1.1 Hauptnavigation
- `Kurs` (Wochenuebersicht): `lib/kurs_uebersicht.dart`
- `Mediathek`: `lib/mediathek_seite.dart`
- `Vertiefung`: `lib/vertiefung_seite.dart`

### 1.2 Vertiefende/sekundaere Seiten
- Wochen-Detailseite: `lib/wochen_detail_seite.dart`
- Textarchiv: `lib/text_archiv_seite.dart`
- Profil: `lib/profil_seite.dart`
- Downloads: `lib/downloads_seite.dart`
- Tag der Achtsamkeit: `lib/tag_der_achtsamkeit_seite.dart`
- Glossar/FAQ: `lib/glossar_faq_seite.dart`
- Literatur: `lib/literatur_seite.dart`
...
- `lib/wochen_detail_seite.dart`
- `lib/vertiefung_seite.dart`
- `lib/literatur_seite.dart`
- `lib/tag_der_achtsamkeit_seite.dart`

### 3.2 Surface-Icon-Buttons (Duplikate)
Sehr aehnliche Implementierung in:
- `lib/wochen_detail_seite.dart`
- `lib/mediathek_seite.dart`
...
- `lib/wochen_detail_seite.dart`
- `lib/downloads_seite.dart`
- `lib/tag_der_achtsamkeit_seite.dart`

### 3.6 Reading-Karten (inkonsistent)
- Wochen-Lesesektion: `lib/widgets/weekly_reading_section.dart`
- Textarchiv: `lib/text_archiv_seite.dart`
...
### 4.1 Kursuebersicht
Datei: `lib/kurs_uebersicht.dart`
...
Datei: `lib/wochen_detail_seite.dart`
